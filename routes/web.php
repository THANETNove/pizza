...
Route::post('/topping-index', [ToppingController::class, 'index'])->name('topping-index');
...
Route::post('/promotion-index', [PromotionController::class, 'index'])->name('promotion-index');
